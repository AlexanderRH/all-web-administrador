function Nuevo()
{
	try
	{
		...
		var bidtanexo = document.getElementById("cboTipoAnexo").value
		var bestado = document.getElementById("cboEstado").value
...
function Editar(idusuario)
{
	try
	{
		var bcampo = document.getElementById("cboCampoFiltro").value
		var bfiltro = document.getElementById("txtFiltro").value
		var bidempresa = document.getElementById("cboEmpresa").value
		var bidtanexo = document.getElementById("cboTipoAnexo").value
		var bestado = document.getElementById("cboEstado").value
...
function Buscar(verificar)
{
	try
	{
		...
		var divGrillaUsuario = document.getElementById("divGrillaUsuario")

		var url = "usuario_lista_data.asp?token=" + token +
										"&accion=lista_usuario" +
										"&campo=" + bcampo +
										"&filtro=" + escape(bfiltro) +
										"&idempresa=" + bidempresa +
										"&idtanexo=" + bidtanexo +
										"&estado=" + bestado

		if(verificar == 1)
			if(document.getElementById("txtGrillaUsuarioURL").value == url)
				return false
		...
		ajax.onreadystatechange=
			function()
			{
				...
				{
					document.getElementById("txtGrillaUsuarioURL").value = url
					divProceso.style.display = "none"
					divGrillaUsuario.innerHTML = ajax.responseText
